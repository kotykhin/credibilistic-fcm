...
def draw_model_2d(fcm, test_data, headers):
    ...
    fig, axes = plt.subplots(len(all_combination_features), 2, figsize=(12, 5 * len(all_combination_features)))
    fig.suptitle('Credibilistic fuzzy clustering result', fontsize=16)
    i = 0 
    ...
    html = 'Credibilistic fuzzy clustering result' + '<img src=\'data:image/png;base64,{}\'>'.format(encoded)
